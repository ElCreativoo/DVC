          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-10 animate-fadeUp" style={{ animationDelay: '270ms' }}>
              ...
              <a href="https://wa.me/41796631441" target="_blank" rel="noreferrer"
                className="flex items-center justify-center gap-2 bg-[#25D366] text-white px-8 py-4 rounded-full text-sm font-semibold tracking-wide hover:bg-[#1ebe5d] transition-all duration-300 text-center shadow-lg">
