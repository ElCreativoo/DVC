...
export default function App() {
  ...
  return (
    <div className="bg-cream text-bark overflow-x-hidden">
      ...
      <a href="https://wa.me/41796631441" target="_blank" rel="noreferrer"
        className="fixed bottom-6 right-5 z-40 md:hidden flex items-center gap-2 bg-[#25D366] text-white pl-4 pr-5 py-3 rounded-full shadow-xl shadow-black/20 hover:bg-[#1ebe5d] transition-all duration-300 hover:scale-105 active:scale-95">
