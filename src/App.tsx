        ...
        <div className={`max-w-7xl mx-auto px-5 md:px-10 flex items-center justify-between ${
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={() => setMenuOpen(!menuOpen)} aria-label="Menü"
              className={`md:hidden flex flex-col items-center gap-1 ${scrolled ? 'text-bark' : 'text-white'}`}>
              ...
              <span className="text-[9px] font-semibold tracking-widest uppercase leading-none opacity-70">Menü</span>
            </button>
          </div>
        </div>
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-10 animate-fadeUp" style={{ animationDelay: '270ms' }}>
              ...
              <a href="https://wa.me/41796631441" target="_blank" rel="noreferrer"
                className="sm:hidden flex items-center justify-center gap-2 bg-[#25D366] text-white px-8 py-4 rounded-full text-sm font-semibold tracking-wide hover:bg-[#1ebe5d] transition-all duration-300 text-center shadow-lg">
                <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 0C5.373 0 0 5.373 0 12c0 2.127.558 4.126 1.534 5.856L.057 23.428a.75.75 0 00.921.921l5.573-1.477A11.943 11.943 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75a9.713 9.713 0 01-4.953-1.354l-.355-.211-3.668.972.986-3.595-.231-.371A9.712 9.712 0 012.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75z"/></svg>
            ...
            <div className="flex items-end sm:items-center gap-3 sm:gap-8 animate-fadeUp" style={{ animationDelay: '350ms' }}>
              ...
              <img
                ...
                alt="Das verrückte Café zum Hoheneck"
                className="h-32 sm:h-48 md:h-60 object-contain object-left drop-shadow-[0_2px_20px_rgba(0,0,0,0.8)] sm:-ml-4 md:-ml-6 flex-shrink-0 translate-y-12 sm:translate-y-4"
              />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <FadeIn>
            <div className="bg-caramel/15 border border-caramel/25 rounded-3xl p-8 md:p-10 flex flex-col md:flex-row md:items-start gap-8 md:gap-14">
              ...
              <div className="h-px md:h-12 w-full md:w-px bg-caramel/25 flex-shrink-0" />
              <div>
